            ...
            <div class="w-full max-w-[480px] rounded-2xl bg-white p-8 shadow-xl sm:p-10">
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a :href="route('auth.google.redirect')" class="flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
