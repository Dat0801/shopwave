        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl border border-indigo-100 bg-indigo-50 p-4">
                <div class="flex gap-4">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-gray-900">Manage Your Addresses</h3>
                        <p class="mt-1 text-sm text-gray-600">Save your shipping addresses for a faster checkout experience. <Link :href="route('addresses.index')" class="font-medium text-indigo-600 hover:text-indigo-500">Manage addresses</Link></p>
                    </div>
                </div>
            </div>
