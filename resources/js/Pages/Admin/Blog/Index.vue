...
// Mock categories for filter - in a real app these might come from props or DB
const categories = ['All Categories', 'Style Guide', 'Product News', 'UX Design', 'Sustainable Fashion', 'Trends', 'Lifestyle'];
