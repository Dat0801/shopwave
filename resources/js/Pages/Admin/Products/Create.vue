            ...
            <div>
                <nav class="mb-2 flex text-sm text-gray-500">
                    <ol role="list" class="flex items-center space-x-2">
                        <li><Link :href="route('admin.products.index')" class="hover:text-gray-700">Products</Link></li>
                        <li><span class="mx-2">/</span></li>
                        <li><span class="font-medium text-gray-900">Create New Product</span></li>
                    </ol>
                </nav>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-8 flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                ...
                <div class="flex gap-4">
                    <button type="button" class="rounded-lg bg-blue-50 px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-100">
                        Save as Draft
                    </button>
                    <button
                        type="submit"
